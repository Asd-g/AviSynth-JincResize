...
/*	for (int64_t row = iTaps; row < iHeightEl - iTaps; row++) // input lines counter
	{
		...
		for (int64_t col = iTaps; col < iWidthEl - iTaps; col += 24) // input cols counter
		{
			float* pfColStart = pfInpRowSamplesFloatBufStart + col;
			...
			for (int64_t k_row = 0; k_row < iKernelSize; k_row++)
			{
				...
				__m256 my_ymm0, my_ymm1; // kernel samples
				__m256 my_ymm2, my_ymm3, my_ymm4, my_ymm5, my_ymm6, my_ymm7, my_ymm8; // out samples
				__m256 my_ymm9, my_ymm10, my_ymm11, my_ymm12, my_ymm13, my_ymm14; // inp samples
				__m256 my_ymm15; //  temp
				...
				my_ymm8 = _mm256_load_ps(pfProc + 48);
				my_ymm15 = _mm256_load_ps(pfProc + 56); //[in8_01;in8_23;in8_45;xx]

/* !! remove 	my_ymm15 = _mm256_set_ps(7, 6, 5, 4, 3, 2, 1, 0); - debug values for check how permutes work
				my_ymm15 = _mm256_permutevar8x32_ps(my_ymm15, _mm256_set_epi32(1, 0, 5, 4, 3, 2, 7, 6)); // [xx;in8_23;in8_45;in8_01]
				...
				my_ymm14 = _mm256_broadcast_ss(pfColStart + 20); // 21

				// 1st sample
				my_ymm2 = _mm256_fmadd_ps(my_ymm0, my_ymm9, my_ymm2);
				my_ymm3 = _mm256_fmadd_ps(my_ymm1, my_ymm9, my_ymm3);

				// 5 sample
				my_ymm3 = _mm256_fmadd_ps(my_ymm0, my_ymm10, my_ymm3);
				my_ymm4 = _mm256_fmadd_ps(my_ymm1, my_ymm10, my_ymm4);

				// 9 sample
				my_ymm4 = _mm256_fmadd_ps(my_ymm0, my_ymm11, my_ymm4);
				my_ymm5 = _mm256_fmadd_ps(my_ymm1, my_ymm11, my_ymm5);

				// 13 sample
				my_ymm5 = _mm256_fmadd_ps(my_ymm0, my_ymm12, my_ymm5);
				my_ymm6 = _mm256_fmadd_ps(my_ymm1, my_ymm12, my_ymm6);

				// 17 sample
				my_ymm6 = _mm256_fmadd_ps(my_ymm0, my_ymm13, my_ymm6);
				my_ymm7 = _mm256_fmadd_ps(my_ymm1, my_ymm13, my_ymm7);

				// 21 sample
				my_ymm7 = _mm256_fmadd_ps(my_ymm0, my_ymm14, my_ymm7);
				my_ymm8 = _mm256_fmadd_ps(my_ymm1, my_ymm14, my_ymm8);

				my_ymm15 = _mm256_blend_ps(my_ymm15, my_ymm2, 3); // store out 01 [out_01;in8_23;in8_45;in8_01]

				my_ymm2 = _mm256_permutevar8x32_ps(my_ymm2, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm3 = _mm256_permutevar8x32_ps(my_ymm3, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm2 = _mm256_blend_ps(my_ymm2, my_ymm3, 192); // copy higher 2 floats

				my_ymm4 = _mm256_permutevar8x32_ps(my_ymm4, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm3 = _mm256_blend_ps(my_ymm3, my_ymm4, 192); // copy higher 2 floats

				my_ymm5 = _mm256_permutevar8x32_ps(my_ymm5, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm4 = _mm256_blend_ps(my_ymm4, my_ymm5, 192); // copy higher 2 floats

				my_ymm6 = _mm256_permutevar8x32_ps(my_ymm6, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm5 = _mm256_blend_ps(my_ymm5, my_ymm6, 192); // copy higher 2 floats

				my_ymm7 = _mm256_permutevar8x32_ps(my_ymm7, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm6 = _mm256_blend_ps(my_ymm6, my_ymm7, 192); // copy higher 2 floats

				my_ymm8 = _mm256_permutevar8x32_ps(my_ymm8, _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm7 = _mm256_blend_ps(my_ymm7, my_ymm8, 192); // copy higher 2 floats

				// load next hi 2 ps from temp
				my_ymm8 = _mm256_blend_ps(my_ymm8, my_ymm15, 192); // copy higher 2 floats [out_01;in8_45;in8_23;xx]
				...
				my_ymm14 = _mm256_broadcast_ss(pfColStart + 21); // 22 

				my_ymm15 = _mm256_permutevar8x32_ps(my_ymm15, _mm256_set_epi32(3, 2, 1, 0, 5, 4, 7, 6)); // [xx;in8_45;out_01;in8_23]
				...
				my_ymm2 = _mm256_permutevar8x32_ps(my_ymm2, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm3 = _mm256_permutevar8x32_ps(my_ymm3, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm2 = _mm256_blend_ps(my_ymm2, my_ymm3, 192); // copy higher 2 floats

				my_ymm4 = _mm256_permutevar8x32_ps(my_ymm4, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm3 = _mm256_blend_ps(my_ymm3, my_ymm4, 192); // copy higher 2 floats

				my_ymm5 = _mm256_permutevar8x32_ps(my_ymm5, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm4 = _mm256_blend_ps(my_ymm4, my_ymm5, 192); // copy higher 2 floats

				my_ymm6 = _mm256_permutevar8x32_ps(my_ymm6, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm5 = _mm256_blend_ps(my_ymm5, my_ymm6, 192); // copy higher 2 floats

				my_ymm7 = _mm256_permutevar8x32_ps(my_ymm7, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm6 = _mm256_blend_ps(my_ymm6, my_ymm7, 192); // copy higher 2 floats

				my_ymm8 = _mm256_permutevar8x32_ps(my_ymm8, _mm256_setr_epi32(1, 0, 7, 6, 5, 4, 3, 2)); // circulate by 2 ps to the left
				my_ymm7 = _mm256_blend_ps(my_ymm7, my_ymm8, 192); // copy higher 2 floats

				// load next hi 2 ps from temp
				my_ymm8 = _mm256_blend_ps(my_ymm8, my_ymm15, 192); // copy higher 2 floats [out_23;in8_45;out_01;xx]
				...
				my_ymm14 = _mm256_broadcast_ss(pfColStart + 22); // 23 

				my_ymm15 = _mm256_permutevar8x32_ps(my_ymm15, _mm256_set_epi32(3, 2, 5, 4, 1, 0, 7, 6)); // [xx;out_23;out_01;in8_45]
				...
				my_ymm8 = _mm256_blend_ps(my_ymm8, my_ymm15, 192); // copy higher 2 floats [out_45;out_23;out_01;xx]
				...
				my_ymm14 = _mm256_broadcast_ss(pfColStart + 23); // 24 

				// final permute before store
				my_ymm15 = _mm256_permutevar8x32_ps(my_ymm15, _mm256_set_epi32(7, 6, 1, 0, 3, 2, 5, 4)); // [out_01;out_23;out_45;xx]
				...
				_mm256_store_ps(pfProc + 54, my_ymm8);
...
void JincResize::KernelRowAll_avx2_mul2_taps4_cb_20s(unsigned char* src, int iSrcStride, int iInpWidth, int iInpHeight, unsigned char* dst, int iDstStride)
{
	// current input plane sizes
	iWidthEl = iInpWidth + 2 * iKernelSize;
	iHeightEl = iInpHeight + 2 * iKernelSize;
	...
	for (int64_t row = iTaps; row < iHeightEl - iTaps; row++) // input lines counter
	{
		...
		for (int64_t col = iTaps; col < iWidthEl - iTaps; col += 24) // input cols counter
		{
			...
			for (int64_t k_row = 0; k_row < iKernelSize; k_row++)
			{
				...
				__m256 my_ymm0, my_ymm1; // kernel samples
				__m256 my_ymm2, my_ymm3, my_ymm4, my_ymm5, my_ymm6, my_ymm7; // out samples
				const __m256i my_ymm8_main_circ = _mm256_set_epi32(1, 0, 7, 6, 5, 4, 3, 2); // main circulating cosst
				__m256i my_imm_perm; // to temp ymm
				__m256 my_ymm9, my_ymm10, my_ymm11, my_ymm12, my_ymm13; // inp samples
				__m256 my_ymm15; //  temp
				...
				// 9 sample
				my_ymm4 = _mm256_fmadd_ps(my_ymm1, my_ymm0, my_ymm4);
				my_ymm5 = _mm256_fmadd_ps(my_ymm1, my_ymm1, my_ymm5);
...
void JincResize::ConvertiMulRowsToInt_avx2(int iInpWidth, int iOutStartRow, unsigned char* dst, int iDstStride)
{
	const int col32 = (iInpWidth*iMul) - ((iInpWidth*iMul) % 32);
...
void JincResize::GetInpElRowAsFloat_avx2(int iInpRow, int iCurrInpHeight, int iCurrInpWidth, unsigned char* pCurr_src, int iCurrSrcStride, float* dst)
{
    int64_t col;
